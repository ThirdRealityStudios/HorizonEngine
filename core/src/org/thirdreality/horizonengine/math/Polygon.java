...
public class Polygon extends com.badlogic.gdx.math.Polygon
{
    ...
    private Short[][] removeDoublesAndPrepare(ArrayList<ArrayList<Short>> connections)
    {
        ...
        // The new format is then used to construct every triangle by a mathematical method.
    ...
    private Short[][] connectVertices()
    {
        ...
        // The double-loop just goes through all possibilities to build lines which go to every vertex point of the polygon.
    ...
    // In this case, just try another starting point. If you tried yet every starting point, this polygon is simply too complex for this algorithm.
