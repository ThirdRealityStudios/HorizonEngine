...
{
    private static Rectangle unprojectRectangle(Rectangle rect, Camera camera)
    {

        Vector3 origin = camera.unproject(new Vector3(rect.x, rect.y, 1f));
        Vector3 corner = camera.unproject(new Vector3(rect.x + rect.width, rect.y + rect.height, 1f));
    ...
    public static Rectangle getClippingBounds(Viewport viewport, Camera screen)
    {
        ...
        return unprojectRectangle(clipRect, viewport.getCamera());
    }
