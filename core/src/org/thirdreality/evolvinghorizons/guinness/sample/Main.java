...
public class Main
{
	...
	private void initComponents()
	{
		...
		Image i = ImageToolkit.loadImage(Path.USER_DIR + File.separator + "media" + File.separator + "MountainLake.jpg");
	...
	public void setupGWindow0()
	{
		...
		Image imgMountain = ImageToolkit.loadImage(Path.USER_DIR + File.separator + "media" + File.separator + "MountainLake.jpg");
