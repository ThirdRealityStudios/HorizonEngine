...
public class GIPoint extends Point2D.Float
{
	...
	public GIPoint add(Float point)
	{
		x += point.x;
		y += point.y;
	...
	public GIPoint add(Float point, boolean condition)
	{
	...
	public GIPoint sub(Float point)
	{
		x -= point.x;
		y -= point.y;
	...
	public GIPoint sub(Float point, boolean condition)
	{
	...
	public GIPoint mul(Float point)
	{
		x *= point.x;
		y *= point.y;
	...
	public GIPoint mul(Float point, boolean condition)
	{
	...
	public GIPoint div(Float point)
	{
		x /= point.x;
		y /= point.y;
	...
	public GIPoint div(Float point, boolean condition)
	{
